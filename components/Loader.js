Vue.component("Loader", {
    template: `
    <svg id="icon-spinner" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" height="24px">
      <rect width="24" height="24" transform="rotate(180 12 12)" opacity="0"></rect>
      <path d="M12 2a1 1 0 0 0-1 1v2a1 1 0 0 0 2 0V3a1 1 0 0 0-1-1z"></path>
